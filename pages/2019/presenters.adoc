...
Dr James Westland Cain is Principal Architect – Software at Grass Valley, where he develops
software to support collaborative workflows in both Film production and News and Sports
Television. His work research interests include file systems innovation and browser based video
production. He was granted a PhD in Advanced Software Engineering by Reading University and is
currently a Visiting Research Fellow at Brunel University. He has numerous international patents
granted, has published dozens of refereed academic papers and regularly speaks at industrial
conferences.
