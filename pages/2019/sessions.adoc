...
=== link:presenters.html#XYueWang[Yue Wang], link:presenters.html#XNatalia[Natalia]
...
Package management was considered one of the hottest and crucial topics in the last 2 years. In 2017, Bjarne Stroustrup himself said this was a something we needed to solve to keep students interested in {cpp}.
