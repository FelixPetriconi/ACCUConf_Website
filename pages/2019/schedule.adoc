...
link:https://github.com/ACCUConf/PDFs_2019/blob/master/chris_oldwood_-_monitoring__turning_noise_into_signal.pdf[(slides)] +
...
link:https://www.youtube.com/watch?v=a_m440rZ5h8[(video)]
