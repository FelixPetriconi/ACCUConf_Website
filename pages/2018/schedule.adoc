...
link:https://github.com/ACCUConf/ACCUConf_PDFs/blob/master/2018/Felix_Petriconi_-\_Can_I_Change_My_Organization.pdf[(slides)] +
...
link:https://github.com/ACCUConf/ACCUConf_PDFs/blob/master/2018/Marshall_Clow__Jonathan_Wakely_-_010_Tricks_that_only_Library_Implementers_Know.pdf[(slides)] +
