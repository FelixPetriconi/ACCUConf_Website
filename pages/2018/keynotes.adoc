...
.. description: ACCU 2018 Keynote Speakers
.. type: text
////
...
=== _Diversity & Inclusivity in Tech_
...
=== _Kotlin/Native – Embracing existing ecosystems_
...
=== _Software development – learning to walk again_
