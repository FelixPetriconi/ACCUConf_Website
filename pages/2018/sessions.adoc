...
Time to list the best and mopst useful improvements {cpp}17 (in my opinion) provides.
...
[[XEmbracingModernCMakeLibraryDependenciesandPackages]]
...
[[XScriptingGit]]
== Scripting Git
=== link:presenters.html#XCharlesBailey[Charles Bailey]
...
=== link:presenters.html#XJonathanWakeley[Jonathan Wakeley], link:presenters.html#XMarshallClow[Marshall Clow]
